    ...
    <nav v-if="authStore.isLoggedIn" class="bg-white/80 backdrop-blur-md sticky top-0 z-40 border-b border-gray-100/50 shadow-sm transition-all duration-300">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:flex ml-10 space-x-2">
              ...
              <router-link
                ...
                to="/proctoring"
                class="nav-link"
                :class="{ 'nav-link-active': $route.path === '/proctoring' }"
              >
                监考管理
              </router-link>
              <router-link 
      ...
      <div class="md:hidden border-t border-gray-100">
        <div class="px-2 py-2 space-y-1">
          ...
          <router-link to="/appeals" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': $route.path === '/appeals' }">申诉中心</router-link>
          <router-link v-if="authStore.isTeacher" to="/proctoring" class="mobile-nav-link" :class="{ 'mobile-nav-link-active': $route.path === '/proctoring' }">监考管理</router-link>
